"""
    plot the results from saved experiments
    in a single plot per each of the
    1. fraction of latency
    2. num of consolidated
    3. rewards
"""
